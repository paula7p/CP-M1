...
console.log(squareCache(5))    // no volverá a invocar a square, simplemente buscará en la
...
console.log(textoGuiones("Mundo")); // "-Mundo-"
console.log(textoUnderscore("JavaScript")); // "_JavaScript_"
